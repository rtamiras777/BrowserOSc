...
export const ExecutionMetadataSchema = z.object({
  ...
  executionMode: z.enum(['dynamic', 'predefined', 'direct']).default('dynamic'),  // How to execute: dynamic=LLM plans everything, predefined=LLM follows TODO list, direct=parse and execute tools directly
