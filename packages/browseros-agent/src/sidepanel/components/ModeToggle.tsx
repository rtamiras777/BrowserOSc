...
/**
 * ModeToggle - Toggle between Agent Mode (automation), Teach Mode, and Vision Mode
    ...
    <div className='flex items-center'>
      ...
      <div className='inline-flex h-[25px] items-center gap-[2px] rounded-2xl border border-border bg-[hsl(var(--secondary))] p-[2px]'>
        ...
        <button
          ...
          aria-label='Vision mode for dashboard analysis'
          title='Vision mode - Dashboard screenshot and analysis'
        >
          Vision Mode
        </button>
      </div>
